...
function _toPrimitive(input7, hint) {
  if (_typeof(input7) !== "object" || input7 === null)
    return input7;
  var prim = input7[Symbol.toPrimitive];
  if (prim !== void 0) {
    var res = prim.call(input7, hint || "default");
    if (_typeof(res) !== "object")
      return res;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return (hint === "string" ? String : Number)(input7);
}
var TRANSITIONS = {
  toggleable: {
